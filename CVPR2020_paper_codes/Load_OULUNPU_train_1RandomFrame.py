...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        return {'image_x': torch.from_numpy(image_x.astype(float)).float(), 'map_x': torch.from_numpy(map_x.astype(float)).float(), 'spoofing_label': torch.from_numpy(spoofing_label_np.astype(np.int64)).long()}
...
class Spoofing_train(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print('Load_OULUNPU_train.py - class Spoofing_train:')
        ...
        # image_x, map_x = self.get_single_cropped_image_x(image_path, map_path, videoname)
    ...
    # Bernardo
    def get_single_cropped_image_x(self, image_path, map_path, videoname):
        ...
        # print('image_pattern:', image_pattern)
        ...
        map_pattern = map_path + '*depth.png'
        ...
        # print('found_map_path:', found_map_path)
        # sys.exit(0)
        map_x_temp = cv2.imread(found_map_path, 0)
    ...
    def get_single_image_x(self, image_path, map_path, videoname):
        ...
        for temp in range(500):
            ...
            # s = "_%03d_depth1D" % image_id  # original
